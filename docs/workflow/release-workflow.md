...
- [ ] Deferred P0 security items addressed — rate limiting + security headers / `SameSite=Lax` shipped; remaining: lock origin to Cloudflare (issue #55) + input sanitization (security hardening Phase 3)
